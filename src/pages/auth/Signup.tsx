    ...
    <div className="min-h-screen bg-[#02060A] flex relative">
      ...
      <div className="w-2/5 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <p className="text-gray-400 mb-4">Sign up to create an account</p>
            ...
            <InputField
              ...
              suffix={
                <button
                  ...
                  className={`text-gray-400 hover:text-white ${showPassword ? 'text-white' : ''}`}
                >
                  {showPassword ? (
            ...
            <InputField
              ...
              suffix={
                <button
                  ...
                  className={`text-gray-400 hover:text-white ${showConfirmPassword ? 'text-white' : ''}`}
                >
                  {showConfirmPassword ? (
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
      ...
      <div className="w-3/5 bg-gray-700 flex items-center justify-center">
        ...
        <img src="/signup.png" alt="Signup illustration" className="w-full h-full object-cover" />
      </div>
    </div>
  );
};
